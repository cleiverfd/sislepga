@extends('layouts.app')
@section('page_title', 'Expedientes Penal')
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/expedientes/penal') }}">Expedientes</a>
    </li>
    <li class="breadcrumb-item active" aria-current="page">Penal</li>
@endsection
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-hover table-bordered" id="tbl_expedientes">
                                    <thead>
                                        <tr>
    ...
    <div class="modal fade" id="mdlPenalDetalle" role="dialog" tabindex="-1">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" id="bodyModalPenal">
                </div>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script defer>
        ...
        function Get_ListarExpedientes() {
            tblExpedientesCivil = $('#tbl_expedientes').DataTable({
                scrollY: '450px',
                //scrollX: true,
                scrollCollapse: true,
                destroy: true,
        ...
        function fct_RegistrarExpediente() {
            window.open('/expedientes/penal/registrar', '_blank');
        }

        function fct_DetalleExpediente(Id) {
            $.ajax({
                url: `/expedientes/penal/detalle/${Id}`,
                type: 'GET',
                success: function(html) {
                    $('#bodyModalPenal').html(html);
                    $('#mdlPenalDetalle').modal('show');
        ...
        function fct_EditarExpediente(Id_Expediente) {
            window.open(`/expedientes/penal/editar/${Id_Expediente}`, '_blank');
        }
